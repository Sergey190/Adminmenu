...
<li <?php echo (CURRENT_PAGE == "zakas.php" || CURRENT_PAGE == "add_customer.php") ? 'class="active"' : ''; ?>>
                                ...
                                <li <?php echo (CURRENT_PAGE == "customers.php" || CURRENT_PAGE == "add_customer.php") ? 'class="active"' : ''; ?>>
                                    ...
                                    <li>
                                        <a href="add_klient.php"><i class="fa fa-plus fa-fw"></i>Добавить новое</a>
                                    </li>
                                    </ul>
                                </li>
...
<div class="row">
     <div class="col-lg-12">
            <h2 class="page-header">Даные о заказе</h2>
        </div>
...
<div class="container">
 ...
 <div class="form-group">
  <i class="fa fa-car"></i><h4>Автомобиль: <?= $product['car'] ?></h4>
 </div>
    <span class="heading"></span>

 <div class="form-group help">
  <h4> <i class="fa fa-user"></i>ФИО: <?= $product['fio'] ?></h4>
 ...
 <div class="form-group help">
  ...
  <h4>Адрес подач.: <?= $product['adres'] ?></h4>
  <i class="fa fa-location-arrow"></i>
   </div>

 <div class="form-group help">

  <h4>Дата почи.: <?= $product['data']  ?>-<?= $product['mes']?></h4>
  <i class="fa fa-calendar"></i>
   </div>
    <div class="form-group help">

  <h4>Кол.дней.: <?= $product['koll'] ?></h4>
  ...
  <h4>Итоговая сумма.: <?= $product['profit'] ?> грн.</h4>
