...
echo '<select name="fio" id="disabledSelect" class="form-control"" >';
 echo '<option value="mark11a" id="ff"  placeholder="Выберете ФИО"></option>';
...
?>
    ...
    <div class="form-group">Адреса *</label>
...
$('.mask-phone').mask('+38 (999) 999-99-99');
      ...
      <input id="date" name="month"value="1231" type="text" tabindex="1" class="form-control" placeholder="Дата рождение" >
