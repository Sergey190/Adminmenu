...
<div class="row">
     <div class="col-lg-12">
            <h2 class="page-header">Додати Замовлення</h2>
        </div>
...
<form action="insert_into.php" method="POST" oninput="dayscountval.value=dayscount.value">
                <fieldset>
                    ...
                    <legend>Ареда автомобіля</legend>
<br>
    <label>Вибрати автомобіль <span class="red">*</span></label> 
    <?php  
...
echo '<select id="country" name="country" class="country" >';
 echo '<option value="mark11a" id="ff"  placeholder="Вибрати автомобіль"></option>';
...
$('.mask-phone').mask('+38 (999) 999-99-99');
       ...
       <label>Адрес подачи</label> 
                ...
                <div class="half-width output-area">
                    <output name="dayscountval">2 </output>- кол.дніві
                </div>
                <div class="buttons">
