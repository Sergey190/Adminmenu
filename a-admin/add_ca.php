...
$sql = "INSERT INTO `car` (`id_car`,`model`, `marka`,`obem`, `klass`,`privod`, `toplivo`,`koroka`, `tipkuzova`, `image`,`goss`, `vin`) VALUES  (NULL,:model, :marka,:obem,:klass,:privod,:toplivo,:koroka,:tipkuzova,:image,:goss,:vin)";
