...
<div id="page-" class="col-md-4 col-md-offset-4">
	<form class="form loginform" method="POST" action="authenticate.php">
		<div class="login-panel panel panel-default">
			<div class="panel-heading">Будь ласка, зайдіть </div>
			<div class="panel-body">
				<div class="form-group">
					<label class="control-label">Введіть логін</label>
					<input type="text" name="username" class="form-control" required="required">
				</div>
				<div class="form-group">
					<label class="control-label">Введіть пароль</label>
					<input type="password" name="passwd" class="form-control" required="required">
				</div>
				<div class="checkbox">
					<label>
						<input name="remember" type="checkbox" value="1">Запам'ятай мене
					</label>
				</div>
				...
				<?php endif; ?>
				<button type="submit" class="btn btn-success loginField">Увійти</button>
			</div>
		</div>
	</form>
</div>
