...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Адмін панель:«Suite».</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
...
<script>
 ...
 primaryHeader: {
 text: "Ціни на авто-прокат"
 },
 dataSeries: [{
 seriesType: '',
 collectionAlias: 'прибуток',
 data: [840, 960, 1400, 1000, 0.177, 0.189, 0.180, 0.183, 0.188, 0.160, 0.176, 0.178]
 }, {
 seriesType: 'line',
 collectionAlias: 'Оренда',
...
<script>
 ...
 dataSeries: [{
 seriesType: 'line',
 collectionAlias: "Бюджет в тисячу",
