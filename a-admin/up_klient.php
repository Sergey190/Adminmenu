...
<div class="row">
     <div class="col-lg-12">
            <h2 class="page-header">Изменить даные клиента</h2>
        </div>
...
<form id="formx"  method="POST" action="javascript:void(null);" onsubmit="call()" >
  <fieldset >
    <div class="form-group">
      ...
      <label for="disabledSelect">ФИО *</label>
...
$('.mask-phone').mask('+38 (999) 999-99-99');
      ...
      <div class="form-group">Дата рождение</label>
 ...
 <a class="s11" href="customers.php" >Отмена</a>
  </fieldset>
</form>
