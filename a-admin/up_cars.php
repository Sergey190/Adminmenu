...
<div class="row">
     <div class="col-lg-12">
            <h2 class="page-header">Изменить даные Авто</h2>
        </div>
...
<form id="formx"  method="POST" action="javascript:void(null);" onsubmit="call() " enctype="multipart/form-data">
  <fieldset >
    ...
    <div class="form-group">Марка </label>
      ...
      <input  value="<?= $product['privod'] ?> "  id="date" name="privod"value="1231" type="text" tabindex="1" class="form-control" placeholder="Дата рождение" >

    </div>
    <div class="form-group">Топливо</label>
      <input  value="<?= $product['toplivo'] ?> "  id="date" name="toplivo"value="1231" type="text" tabindex="1" class="form-control" placeholder="Дата рождение" >

    </div>
    <div class="form-group">Коробка</label>
      <input  value="<?= $product['koroka'] ?> "  id="date" name="koroka"value="1231" type="text" tabindex="1" class="form-control" placeholder="Дата рождение" >

    </div>
    <div class="form-group">Тип кузова</label>
      <input  value="<?= $product['tipkuzova'] ?> "  id="date" name="tipkuzova"value="1231" type="text" tabindex="1" class="form-control" placeholder="Дата рождение" >
...
$height = 260;
 ...
 <a class="s11" href="add_car.php" >Отмена</a>
  </fieldset>
</form>
