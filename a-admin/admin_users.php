...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-6">
            <h1 class="page-header">Учасники з правами адміністратора</h1>
        </div>
        <div class="col-lg-6">
            <div class="page-action-links text-right">
                <a href="add_admin.php" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> Додати нове</a>
            </div>
        </div>
    </div>
    ...
    <div class="well text-center filter-form">
        <form class="form form-inline" action="">
            ...
            <label for="input_order">Сортувати</label>
    ...
    <table class="table table-striped table-bordered table-condensed">
        <thead>
            <tr>
                ...
                <th width="45%">Ім'я</th>
                <th width="40%">Тип адміністратора</th>
                <th width="10%">Дія</th>
            </tr>
        </thead>
        <tbody>
